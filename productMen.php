...
?>
    ...
    <body>
            ...
            <div class="filter" style="position:absolute;width:400px;right:79%;margin:0 !important;padding:0 !important">
                <div class="container">
                    <div class="py-3">
                        ...
                        <ul class="list-group">
                            <a href="productMen.php?type=T-Shirts">
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"> T-shirts <i class="fas fa-tshirt"></i> <span class="badge badge-primary badge-pill"><?php echo $numT; ?></span> </li>
                            </a>
                            <a href="productMen.php?type=jeans">
                            ...
                            <a href="productMen.php?type=Hoodies">
                            ...
                            <a href="productMen.php?type=Snickers">
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"> Snickers <i class="fas fa-shoe-prints"></i><span class="badge badge-primary badge-pill"><?php echo $numS; ?></span> </li>
                            </a>
                            <a href="productMen.php?type=Jackets">
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category"> Jackets <i class="fas fa-user-tie"></i><span class="badge badge-primary badge-pill"><?php echo $numJA; ?></span> </li>
                            </a>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="py-3">
                        ...
                        <ul class="list-group">
                            ...
                            <a href="javascript:void(0)" onclick="filterPrice(300,400);">
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">Between 300->400 </li>
                            </a>
                            <a href="javascript:void(0)" onclick="filterPrice(400,500);">
                                <li class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category">Between 400->500 </li>
                            </a>
                        </ul>
                    </div>
                </div>
        ...
        <section class="section-products" style="display: none;" id="filterId">
            <div class="container">

                <div class="row justify-content-center text-center">
                    <div class="col-md-8 col-lg-6">
                        <div id="title" style="display: none;" class="header">
        ...
        <section class="section-products">
            <div class="container">
                ...
                <div class="row">
                    ...
                    if (isset($_GET['type'])) {
                        $type = $_GET['type'];
                        $sql = "SELECT * FROM product_men WHERE titre = '$type'";
		...
		transition: all 0.3s;">
                                ...
                                <ul style="display:flex;align-items:center;justify-content:center">
                                        ...
                                        <li ><a href="javascript:void(0)" class="a" onclick="addFavoris(' . $line['idPro'] . ');" id="heart"><i  class="fas fa-heart"></i></a></li>
                                        <li><a href="#" class="a"><i class="fas fa-expand"></i></a></li>
                                </ul>
                        </div>
                        <div class="part-2">
        ...
        ';
                            ...
                            echo '<h1 style="font-size: 10rem;">yes</h1>';
                            if (mysqli_num_rows($result) > 0) {
                                while ($line = mysqli_fetch_assoc($result)) {
                                    echo '					
                <div class="col-md-6 col-lg-4 col-xl-3">
