        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 430px;cursor:pointer">
                    <img src="img/tshirt-men1.jpeg" alt="" class="card-img-top" style="width:100%">

                    <div class="card-body">
                        <h4 class="card-title">Trending T-shirts</h4>
                        <p class="card-text">Check out our latest T-shirts design there are!</p>
                        <div class="wrapper">
                            <a class="cta" href="productMen.php?type=T-Shirts" style="color: white;text-decoration:none">
                                <span>Shop</span>
                                <span>
            ...
            <div class="col">
                <div class="card" style="width: 430px;cursor:pointer;">
                    <img src="img/jeans-men1.jpeg" alt="" class="card-img-top" style="width:100%">

                    <div class="card-body">
                        <h4 class="card-title">Trending Jeans</h4>
                        <p class="card-text">Check out our the top tier jeans!</p>
                        <div class="wrapper">
                            <a class="cta" href="productMen.php?type=jeans" style="color: white;text-decoration:none">
                                <span>Shop</span>
                                <span>
                                    <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="col">
                <div class="card" style="width: 430px;cursor:pointer">
                    <img src="img/hoodies-men1.jpeg" alt="" class="card-img-top" style="width:100%">

                    <div class="card-body">
                        <h4 class="card-title">Trending Hoodies</h4>
                        <p class="card-text">Check out our best quality hoodies!</p>
                        <div class="wrapper">
                            <a class="cta" href="productMen.php?type=Hoodies" style="color: white;text-decoration:none">
                                <span>Shop</span>
                                <span>
                                    <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="col">
                <div class="card" style="width: 430px;cursor:pointer">
                    <img src="img/jacketCategory.jpg" alt="" class="card-img-top" style="width:100%;height:100%">

                    <div class="card-body">
                        <h4 class="card-title">Trending Jackets</h4>
                        <p class="card-text">Check out our best quality jackets!</p>
                        <div class="wrapper">
                            <a class="cta" href="productMen.php?type=Jackets" style="color: white;text-decoration:none">
                                <span>Shop</span>
                                <span>
                                    <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="col">
                <div class="card" style="width: 430px;cursor:pointer">
                    <img src="img/sneakersCategory.jpg" alt="" class="card-img-top" style="width:100%">

                    <div class="card-body">
                        <h4 class="card-title">Trending Snickers</h4>
                        <p class="card-text">Check out our best quality snickers!</p>
                        <div class="wrapper">
                            <a class="cta" href="productMen.php?type=Snickers" style="color: white;text-decoration:none">
                                <span>Shop</span>
                                <span>
                                    <svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                        <g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
